...
const form = document.querySelector(".editusers form"), // Selecting the addadmin form element
      editBtn = form.querySelector(".button input"), // Selecting the submit button inside the form
...
editBtn.onclick = () => {
    ...
    xhr.open("POST", "php/editusers.php", true);
